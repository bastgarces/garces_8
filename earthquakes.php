...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6.5){?> style="color:RGB(224, 21, 36);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 6){ ?> style="color:RGB(149, 83, 84);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5.5){ ?> style="color:RGB(48, 132, 70);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(36, 231, 17);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4.5){ ?> style="color:RGB(34, 113, 179);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4){ ?> style="color:RGB(108, 70, 50);" <?php } else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
