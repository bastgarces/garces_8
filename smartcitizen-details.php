...
<h1>Temperatura: <?php echo round($json_data ['data']['sensors'][3]['value'],1);?>ºC</h1>
<h1>Humedad: <?php echo round($json_data ['data']['sensors'][2]['value'],1);?>%</h1>
<h1>Ruido: <?php echo round($json_data ['data']['sensors'][7]['value'],1);?> dB</h1>
<h1>Luminosidad: <?php echo round($json_data ['data']['sensors'][0]['value'],1);?> luz</h1>
